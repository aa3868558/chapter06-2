...
@Test public  void  mohu()
{
    ...
    @Test public  void  mohu1(){
       ...
       Map<String,Object> map=new HashMap<>();
        ...
        map.put("spilinfoaim2","学习");
        List<student> list=sqlSession.selectList("mohu",map);
        for (student list1:list)
        {
            System.out.println(list1.getDepinfoid()+"   "+list1.getSpilinfoid()+"   "+list1.getSpilinfocode()+"   "+list1.getSpilinfoname()+"   "+list1.getSpilinfoaim()+"   "+list1.getSpilinfoprodire());
